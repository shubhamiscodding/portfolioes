        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm flex flex-col items-center text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 group"
                >
          ...
          <div>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="text-gray-600 dark:text-gray-400 mb-2 block">Name</label>
                <Input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div>
                <label className="text-gray-600 dark:text-gray-400 mb-2 block">Mail</label>
                <Input
                  type="email"
                  name="email"
              ...
              <div>
                <label className="text-gray-600 dark:text-gray-400 mb-2 block">Project</label>
                <Textarea
                  name="message"
